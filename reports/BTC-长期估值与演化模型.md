# BTC-长期估值与演化模型 · 全景认知与实践操作手册

> 比特币的长期价格不是「一个公式算出来的」，而是**固定供给 × 流动供给 × 需求曲线 × 矿工地板 × 制度摩擦**五层机制叠出的均衡——本手册教你怎么拆、怎么验、怎么不被 S2F 图表骗。

> 生成于 2026-09-16｜耗时 3 分 57 秒｜主题：BTC-长期估值与演化模型｜标签：比特币、估值、S2F、减半、矿工、ETF
