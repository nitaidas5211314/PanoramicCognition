# 全局博弈：微小私有噪声选出唯一临界点 · 全景认知与实践操作手册

> 完全信息下，货币攻击和银行挤兑在中间一段基本面上**两个均衡都成立**；每人只多一点私有噪声，迭代剔除就把这段压成**一个可计算的临界点**。

> 生成于 2026-09-19｜耗时 24 分 49 秒｜主题：全局博弈：微小私有噪声选出唯一临界点｜标签：博弈论、全局博弈、Global Games、货币危机、银行挤兑、均衡选择、Morris-Shin
