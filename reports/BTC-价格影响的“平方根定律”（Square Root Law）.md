# BTC-价格影响的"平方根定律"（Square Root Law） · 全景认知与实践操作手册

> 大单冲击 **I ∝ √(Q/V)** 是微观结构最硬的经验律——BTC 2014 曾完美符合，2025 机构化后指数可能**从 0.5 漂到 ~0.1**

> 生成于 2026-09-17｜耗时 4 分 29 秒｜主题：BTC-价格影响的"平方根定律"（Square Root Law）｜标签：比特币、平方根定律、市场冲击、订单簿、执行算法
