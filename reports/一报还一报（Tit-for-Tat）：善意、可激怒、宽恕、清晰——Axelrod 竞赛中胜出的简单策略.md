# 一报还一报（Tit-for-Tat）：善意、可激怒、宽恕、清晰 · 全景认知与实践操作手册

> Axelrod 迭代囚徒困境竞赛中，最简单的规则——**先合作，此后复制对方上一步**——两次夺冠。它从不「赢过」对手，却靠诱发合作拿总分；噪声一来，同一规则会掉进报复螺旋。

> 生成于 2026-09-19｜耗时 6 分 54 秒｜主题：一报还一报（Tit-for-Tat）：善意、可激怒、宽恕、清晰｜标签：以牙还牙、Tit-for-Tat、Axelrod、囚徒困境、互惠、合作演化、噪声、Pavlov
...
**▶ Q2 为什么第二轮知道 TFT 能赢还有人输给它？**

复杂策略彼此误伤、或试图剥削善意簇时被惩罚；清晰与善意仍是高分簇入场券。【分析】

**▶ Q3 经典 200 步 TFT vs ALLD 为什么是 199 : 204？**
...
**▶ Q9 如何把 TFT 用到管理而不变成整人？**

惩罚对事不对人、幅度预告、恢复条件明确、重大处分前降噪核实。【分析】

**▶ Q10 Axelrod 的结论有哪些主要批评？**
